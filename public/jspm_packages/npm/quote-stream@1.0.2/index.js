...
(function(Buffer) {
  ...
  var multiByteSeparatorLength = multiByteBuffers.lineSeparator.length;
  var multiByteSeparatorOffset = multiByteSeparatorLength - 1;
  var multiByteSeparatorCode = multiByteBuffers.lineSeparator[0];
  var map = {};
