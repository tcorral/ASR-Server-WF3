    ...
    return (function e(t, n, r) {
      ...
      17: [function(require, module, exports) {
        ...
        function parseJpegInfo(buffer) {
          ...
          while (i < len) {
            ...
            if (view.getUint8(i + 1) === 0xc0 || view.getUint8(i + 1) === 0xc1 || view.getUint8(i + 1) === 0xc2 || view.getUint8(i + 1) === 0xc3 || view.getUint8(i + 1) === 0xc4 || view.getUint8(i + 1) === 0xc5 || view.getUint8(i + 1) === 0xc6 || view.getUint8(i + 1) === 0xc7) {
              return {
      ...
      19: [function(require, module, exports) {
        ...
        Object.defineProperties(CursorFactory.prototype, {
          ...
          bottom: {
            enumerable: true,
            get: function() {
              return this.pages[this.currentPage - 1].bottom;
            }
          }
        });
        ...
        CursorFactory.prototype.addPage = function(parent) {
          var page = new Page(this.currentPage, this.header && this.header.clone().createNode(), this.footer && this.footer.clone().createNode(), (this.afterBreak[this.afterBreak.length - 1] || []).filter(function(child) {
      ...
      20: [function(require, module, exports) {
        ...
        PDF.prototype.createXObject = function(subtype) {
          ...
          if (subtype)
            xobject.addProperty('Subtype', subtype);
      ...
      22: [function(require, module, exports) {
        ...
        Object.defineProperties(BoxNode.prototype, {
          height: {
            ...
            get: function() {
              ...
              var height = this.children.map(function(child) {
                return child.height;
              }).reduce(function(lhs, rhs) {
                return lhs + rhs;
              }, 0) + this.style.getBorderTopWidth() + this.style.paddingTop + this.style.paddingBottom + this.style.getBorderBottomWidth();
        ...
        BoxNode.prototype.beforeContent = function(cursor) {
          ...
          var height = this.height > 0 && this.style.overflow === 'hidden' ? this.height - (top + this.style.paddingBottom + this.style.getBorderBottomWidth()) : undefined;
        ...
        BoxNode.prototype._compute = function(cursor) {
          ...
          this.width = utils.resolveWidth(this.style.width, maxWidth) - this.style.paddingLeft - this.style.getBorderLeftWidth() - this.style.paddingRight - this.style.getBorderRightWidth();
        };
        BoxNode.prototype.begin = function(doc, parent) {
          ...
          if (this.style.backgroundColor !== null) {
            drawBackground(doc, left - (this.style.getBorderLeftWidth() / 2), bottom - (this.style.getBorderBottomWidth() / 2), width, height, this.style.backgroundColor);
          }
          if (this.style.getBorderTopWidth() > 0) {
            drawLine(doc, this.style.getBorderTopWidth(), [left - (this.style.getBorderLeftWidth() / 2), top], [right + (this.style.getBorderRightWidth() / 2), top], this.style.getBorderTopColor());
          }
          if (this.style.getBorderRightWidth() > 0) {
            drawLine(doc, this.style.getBorderRightWidth(), [right, top + (this.style.getBorderTopWidth() / 2)], [right, bottom - (this.style.getBorderBottomWidth() / 2)], this.style.getBorderRightColor());
          }
          if (this.style.getBorderBottomWidth() > 0) {
            drawLine(doc, this.style.getBorderBottomWidth(), [right + (this.style.getBorderRightWidth() / 2), bottom], [left - (this.style.getBorderLeftWidth() / 2), bottom], this.style.getBorderBottomColor());
          }
          if (this.style.getBorderLeftWidth() > 0) {
            drawLine(doc, this.style.getBorderLeftWidth(), [left, bottom - (this.style.getBorderBottomWidth() / 2)], [left, top + (this.style.getBorderTopWidth() / 2)], this.style.getBorderLeftColor());
          }
        };
      ...
      23: [function(require, module, exports) {
        ...
        var CellNode = module.exports = function(cell) {
          ...
          this.type = 'CellNode';
          this.allowBreak = cell.style.allowBreak !== null ? cell.style.allowBreak : this.allowBreak;
          this.cell = cell;
        };
        ...
        Object.defineProperties(CellNode.prototype, {
          minHeight: {
            enumerable: true,
            get: function() {
              return Math.max(this.style.height || 0, this.children.map(function(child) {
                return child.height;
              }).reduce(function(lhs, rhs) {
                return lhs + rhs;
              }, 0));
      ...
      24: [function(require, module, exports) {
        ...
        Object.defineProperties(ConditionalNode.prototype, {
          ...
          x: {
            enumerable: true,
            get: function() {
              return this.children[0] && this.children[0].x;
            },
            set: function() {}
          },
          y: {
            enumerable: true,
            get: function() {
              return this.children[0] && this.children[0].y;
            },
            set: function() {}
          }
        });
      ...
      33: [function(require, module, exports) {
        ...
        var RowNode = module.exports = function(row) {
          ...
          this.allowBreak = row.style.allowBreak !== null ? row.style.allowBreak : this.allowBreak;
          this.row = row;
        ...
        Object.defineProperties(RowNode.prototype, {height: {
            enumerable: true,
            get: function() {
              if (this.style.height > 0 && this.style.overflow === 'hidden') {
                return this.style.height;
              ...
              return Math.max.apply(Math, this.children.map(function(child) {
                var height = child.minHeight + child.style.paddingTop + child.style.paddingBottom + child.style.getBorderTopWidth() + child.style.getBorderBottomWidth();
                return height;
              }, this));
            }
          }});
        ...
        RowNode.prototype._compute = function(cursor) {
          ...
          this.children.forEach(function(child, i) {
            child.width = (this.widths[index++] || 0) - child.style.getBorderLeftWidth() - child.style.paddingLeft - child.style.paddingRight - child.style.getBorderRightWidth();
            if (child.style.colspan > 1) {
              for (var j = 1; j < child.style.colspan; ++j) {
            ...
            offset += child.width + child.style.paddingLeft + child.style.paddingRight + child.style.getBorderRightWidth() + child.style.getBorderLeftWidth();
          }, this);
        };
      ...
      34: [function(require, module, exports) {
        ...
        Object.defineProperties(TablePageBreakNode.prototype, {height: {
            enumerable: true,
            get: function() {
              return this.children.map(function(child) {
                return child.height;
      ...
      37: [function(require, module, exports) {
        ...
        WordNode.prototype.mustUpdate = function(cursor) {
          for (var i = 0,
              len = this.content.length; i < len; ++i) {
      ...
      41: [function(require, module, exports) {
        ...
        var TTFFont = module.exports = function(id, font) {
          ...
          this.prop('DescendantFonts', new PDFArray([this.descendant.toReference()]));
        };
        ...
        TTFFont.prototype.embed = function(doc) {
          ...
          var mapping = this.subset.subset,
              lines = [];
          for (code in mapping) {
            if (lines.length >= 100) {
            ...
            lines.push('<' + ('0000' + (+code - 31).toString(16)).slice(-4) + '>' + '<' + ('0000' + mapping[code].toString(16)).slice(-4) + '>');
          }
          if (lines.length) {
            cmap.writeLine(lines.length + ' beginbfchar');
      ...
      53: [function(require, module, exports) {
        ...
        PDFTrailer.prototype = Object.create(PDFDictionary.prototype, {constructor: {value: PDFTrailer}});
      ...
      55: [function(require, module, exports) {
        ...
        PDFXObject.prototype = Object.create(PDFObject.prototype, {constructor: {value: PDFXObject}});
      }, {
        "./object": 47,
        "./stream": 51
      }],
        ...
        var ContainerStyle = module.exports = function(values) {
          ...
          sides.forEach(function(side) {
            ...
            Object.defineProperty(this, 'padding' + side, {
              enumerable: true,
              get: function() {
                return Math.max(0, value || this.padding || 0);
              },
              set: function(val) {
                value = val;
              }
      ...
      81: [function(require, module, exports) {
        ...
        var Directory = module.exports = new Struct({
          ...
          searchRange: Struct.Uint16.with({$packing: function() {
              return easySearchable(this.numTables) * 16;
            }}),
          entrySelector: Struct.Uint16.with({$packing: function() {
              return Math.log(easySearchable(this.numTables)) / Math.LN2;
            }}),
          rangeShift: Struct.Uint16.with({$packing: function() {
      ...
      83: [function(require, module, exports) {
        var Struct = require('structjs');
        var Table = new Struct({format: Struct.Uint16}, {
          storage: true,
          ...
          for (var i = 0,
            ...
            for (var code = startCode; code <= endCode; ++code) {
              ...
              if (idRangeOffset === 0)
                ...
                id = this.glyphIndexArray[index] || 0;
                if (id != 0)
                  id += idDelta;
              }
        ...
        Object.defineProperty(SubTable.prototype, 'isUnicode', {
          enumerable: true,
          get: function() {
            return ((this.platformID === 3 && this.platformSpecificID === 1) || this.platformID === 0);
          }
        });
      ...
      84: [function(require, module, exports) {
        ...
        Glyph.prototype.pack = function(view, offset) {
          for (var i = 0,
              len = this.view.byteLength; i < len; ++i) {
      ...
      87: [function(require, module, exports) {
        ...
        module.exports = function(numOfLongHorMetrics, numGlyphs) {
          ...
          Hmtx.prototype.for = function(id) {
            if (id in this.hMetrics)
              return this.hMetrics[id];
      ...
      88: [function(require, module, exports) {
        ...
        module.exports = function(indexToLocFormat, numGlyphs) {
          ...
          switch (indexToLocFormat) {
            case 0:
              Loca = new Struct({offsets: Struct.Array(Struct.Uint16, numGlyphs + 1)});
              Loca.prototype.$unpacked = function() {
                for (var i = 0,
                    len = this.offsets.length; i < len; ++i) {
                  this.offsets[i] *= 2;
                }
              };
              ...
              break;
            case 1:
              Loca = new Struct({offsets: Struct.Array(Struct.Uint32, numGlyphs + 1)});
              break;
          }
      ...
      90: [function(require, module, exports) {
        ...
        Name.prototype.embed = function(charMap, trimNames) {
          ...
          for (var i = 0; i < this.records.length; ++i) {
            ...
            if (trimNames && record.platformID !== 0) {
      ...
      93: [function(require, module, exports) {
        ...
        var TTFFont = module.exports = function(buffer) {
          var self = this;
          this.buffer = buffer instanceof TTFFont ? buffer.buffer : buffer = buffer instanceof ArrayBuffer ? buffer : toArrayBuffer(buffer);
          ...
          function unpackTable(table, args) {
            ...
            if (args)
              Table = Table.apply(undefined, args);
          ...
          unpackTable('cmap');
          for (var i = 0,
              len = this.tables.cmap.subtables.length; i < len; ++i) {
          ...
          if (!this.codeMap)
            throw new Error('Font does not contain a Unicode Cmap.');
          unpackTable('head');
          unpackTable('hhea');
          unpackTable('maxp');
          ...
          var flags = 0,
              familyClass = (os2.sFamilyClass || 0) >> 8,
              isSerif = !!~[1, 2, 3, 4, 5, 6, 7].indexOf(familyClass);
          if (this.tables.post.isFixedPitch)
            flags |= 1 << 0;
          if (isSerif)
            flags |= 1 << 1;
          if (familyClass === 10)
        ...
        TTFFont.prototype.stringWidth = function(string, size) {
          var width = 0,
              scale = size / this.tables.head.unitsPerEm;
          for (var i = 0,
        ...
        TTFFont.prototype.save = function() {
          var self = this,
              tables = TTFFont.TABLES;
          for (var name in this.directory.entries) {
            if (!!!~tables.indexOf(name))
              delete this.directory.entries[name];
          }
          var size = offset = this.directory.lengthFor(this.directory, true) * this.directory.sizeFor(this.directory, true);
          tables.forEach(function(name) {
            if (!(name in self.directory.entries))
              return;
            var table = self.tables[name];
            var length = table ? table.lengthFor(table, true) * table.sizeFor(table, true) : self.directory.entries[name].length;
          ...
          tables.forEach(function(name) {
            if (!(name in self.directory.entries))
              return;
            var table = self.tables[name],
                entry = self.directory.entries[name];
            if (!table) {
              var from = new DataView(self.buffer, entry.offset, entry.length);
              for (var i = 0; i < entry.length; ++i)
                view.setUint8(offset + i, from.getUint8(i));
              entry.offset = offset;
            } else {
            ...
            var padding = entry.length % 4,
                length = entry.length + padding;
            for (var i = entry.offset + entry.length,
                to = i + padding; i < to; ++i)
              view.setInt8(i, 0);
            var sum = 0;
      ...
      95: [function(require, module, exports) {
        ...
        StructArray.prototype.read = function read(buffer, offset) {
          var arr = [],
              parent = read.caller.parent;
          for (var i = 0,
              len = this.lengthFor(parent); i < len; ++i) {
            var child;
        ...
        StructArray.prototype.write = function write(buffer, offset, arr) {
          ...
          for (var i = 0,
              len = this.lengthFor(parent, true); i < len; ++i) {
        ...
        StructArray.prototype.sizeFor = function(parent) {
          return (this.struct.sizeFor ? this.struct.sizeFor(parent) : this.struct.prototype.sizeFor(parent)) * (this.struct.lengthFor ? this.struct.lengthFor(parent) : this.struct.prototype.lengthFor(parent));
        };
        StructArray.prototype.lengthFor = function(parent, writing) {
          ...
          if (this._length instanceof StructReference) {
            if (writing)
              return parent[this.prop].length;
      ...
      96: [function(require, module, exports) {
        ...
        StructHash.prototype.write = function write(buffer, offset, hash) {
          var keys = Object.keys(hash),
              parent = write.caller.parent,
              child;
          this.setLength(this.lengthFor(parent, true), parent);
          for (var i = 0,
              len = this.lengthFor(parent); i < len; ++i) {
            if (!(child = hash[keys[i]]))
              continue;
            child.pack(buffer, offset);
            offset += child.lengthFor(parent) * child.sizeFor(parent);
          }
        ...
        StructHash.prototype.lengthFor = function(parent, writing) {
          ...
          if (this._length instanceof StructReference) {
            if (writing)
              return Object.keys(parent[this.prop]).length;
            return parent[this._length.prop];
          }
          return this._length;
        };
      ...
      100: [function(require, module, exports) {
        ...
        StructString.prototype.read = function read(buffer, offset) {
          var str = [],
              storage,
              parent = read.caller.parent,
              shift = this.external ? this.offsetFor(parent) : (this.storage ? offset + this.offsetFor(parent) : offset);
          for (var i = 0,
              len = this.lengthFor(parent),
              step = this.sizeFor() === 2 ? 2 : 1; i < len; ++i) {
